...
hl.on("hyprland.start", function()
	...
	hl.exec_cmd("waybar & swayosd-server & awww-daemon & swayosd-libinput-backend")
...
hl.config({
    plugin = {
        hyprexpo = {
            ...
            show_cursor = 0,
			tile_rounding = 15,
			border_color_current = "#cfc9c2",
			border_color_focus = "#cfc9c2",
			label_enable = 0,
        },
    },
})
